  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-1 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="z-2 fixed bg-black bottom-0 left-0 flex h-24 w-full items-end justify-center lg:static lg:h-24 lg:w-auto lg:bg-none">
          <a
            className="pointer-events-none z-3 flex place-items-center gap-2 p-8 lg:pointer-events-auto lg:p-0"
            href="https://tapx.app"
            target="_blank"
